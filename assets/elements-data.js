...
window.ARTS = [
  ...
  },
  {
    ...
    icon: 'compass',
    blurb: 'Behind every great building stands a certain kind of person. The classical tradition never treated architecture as a merely technical trade: from Vitruvius onward it was understood as a moral and intellectual discipline — one that asked the builder to be learned, honest, patient and humble before proportion and nature. This topic is about the inner life of the architect: what the masters believed, the character the work demanded, and the old conviction that the buildings we raise go on to shape the people who live among them. Present here as the tradition itself understood it — a belief and an argument worth taking seriously, flagged honestly where the claims are contested rather than proven.',
    sections: {
      'what-it-is': {
        title: "The architect's mind",
        intro: 'The classical tradition held that a building is only as good as the person who conceived it, and that architecture is a discipline of character as much as of stone. From Vitruvius through Alberti, Ruskin and Pugin runs a single thread: to build well you must first become a certain kind of person — learned, honest, patient and humble. What follows are the recurring inner dispositions the tradition asked of the architect. Take them as the tradition\'s own account of itself — an ideal it aimed at, presented in its own voice.',
        principles: [
          { name: 'The learned architect', image: 'assets/detail/greek-antiquities.jpg', caption: 'Vitruvius begins his whole treatise with the education of the architect, not with buildings — the building is the visible result of a well-furnished mind.', body: 'Vitruvius opens his whole treatise not with buildings but with the education of the architect. He must be, in the Morgan translation, "educated, skilful with the pencil, instructed in geometry, know much history, have followed the philosophers with attention, understand music, have some knowledge of medicine, know the opinions of the jurists, and be acquainted with astronomy" (De Architectura, Book I, ch. 1). The architect is a generalist who commands many arts and, by his judgement, tests the work of all of them.', why: 'It sets the bar for the tradition: architecture is not a single skill but a wide, ordered understanding of the world. The building is the visible result of a well-furnished mind.' },
          { name: 'Character before commission', image: 'assets/detail/am-character.jpg', caption: 'The oldest demand in the West: that good building depends on a good builder — honest, courteous and free of greed.', body: 'Vitruvius is just as insistent on the architect\'s morals. Philosophy, he writes, "makes an architect high-minded and not self-assuming, but rather renders him courteous, just, and honest without avariciousness… for no work can be rightly done without honesty and incorruptibility" (Book I, ch. 1). He must not be grasping, nor angle for kickbacks, but keep his good reputation with dignity.', why: 'It is the oldest statement in the West that good building depends on a good builder — that honesty and freedom from greed are professional qualifications, not extras. The ethic is nearly two thousand years old.' },
          { name: 'Beauty as a duty', image: 'assets/detail/prop-alberti.jpg', caption: 'Alberti\'s Santa Maria Novella — for the tradition, beauty was not vanity but an obligation owed to everyone who must live with the building.', body: 'For the tradition, beauty was not a luxury added at the end but an obligation the architect owed to those who would use and pass the building. Vitruvius set delight (venustas) alongside soundness and use as one of the three demands of any building (Book I, ch. 3). Alberti went further, calling beauty "the noblest and most necessary" of the three, and defining it as "that reasoned harmony of all the parts within a body, so that nothing may be added, taken away, or altered, but for the worse" (On the Art of Building, Book VI, Rykwert/Leach/Tavernor trans.).', why: 'It reframes beauty as service rather than vanity. A building stands in public for centuries; to make it ugly is, in this view, to do a lasting wrong to everyone who must live with it.' },
          { name: 'Humility before proportion and nature', image: 'assets/detail/prop-vitruvianman.jpg', caption: 'The architect did not invent beauty but submitted to a harmony believed already there — in number, in the human body, and in nature.', body: 'The classical architect did not invent beauty freely; he submitted to a harmony he believed was already there in number, in the human body, and in nature. Alberti called this rightness concinnitas, "the absolute and fundamental rule in Nature" (Book IX). Palladio held that "beauty will result from the form and correspondence of the whole… with the parts, of the parts with regard to each other, and of these again to the whole" (Four Books, I). The task was to find the right relation, not to impose a personal one.', why: 'It is the opposite of the modern cult of self-expression. The discipline begins with obedience — the humility to serve a proportion larger than your own taste.' },
          { name: 'The long view — building for ever', image: 'assets/styles/greek.jpg', caption: 'The Parthenon, still standing after two thousand years — the tradition asked the architect to build for centuries, not for a career.', body: 'The tradition asked the architect to think in centuries, not in careers. Ruskin\'s charge is the clearest statement of it: "when we build, let us think that we build for ever… let it be such work as our descendants will thank us for" (Seven Lamps of Architecture, the Lamp of Memory, 1849). The building outlives its maker and becomes the inheritance and memory of a people.', why: 'It replaces the ego of the moment with responsibility to the future. A person who builds for ever cannot cut a corner, chase a fashion, or build for their own glory.' },
          { name: 'Honesty in building', image: 'assets/detail/mat-facing.jpg', caption: 'Ruskin and Pugin made truthfulness a moral test: no material disguised as another, no structure faked. A dishonest building was a small failure set in stone.', body: 'A recurring moral test in the tradition is truthfulness — that a building should not pretend to be what it is not. Ruskin made "Truth" one of his seven lamps: no structural deceits, no material disguised as another, no machine-made ornament passed off as hand-carved. Pugin\'s rule was kin to it: "there should be no features about a building which are not necessary for convenience, construction, or propriety" (True Principles, 1841).', why: 'It treats a building as a kind of statement that can lie or tell the truth. For these writers, a dishonest building was a small moral failure set in stone — and honesty of construction a quiet virtue.' },
          { name: 'The joy and freedom of the maker', image: 'assets/detail/gt-craft.jpg', caption: 'For Ruskin, the roughness of hand-carved foliage is the mark of a free, thinking workman — a building is only as humane as the labour that raised it.', body: 'Ruskin\'s "The Nature of Gothic" (The Stones of Venice, 1853) argued that a building carries the state of soul of the people who made it. Gothic honours the workman by letting him think, invent and even fail; its roughness is the mark of a free, living hand. To demand machine-perfection, Ruskin warned, is to degrade the worker: "You must either make a tool of the creature, or a man of him. You cannot make both."', why: 'It widens "the architect\'s mind" to every hand on the site. In this view a building is only as humane as the labour that raised it — and joyless work leaves its mark on the stone.' }
        ]
      },
      'the-path': {
        title: 'Cultivating the architect\'s eye and mind',
        intro: 'You do not need to design a building to grow the disposition the tradition prized. It is a way of seeing and a set of habits — attention, honesty, patience, humility before good order — that anyone can cultivate by looking harder and reading the makers in their own words. A rough path, in three passes.',
        heroImage: 'assets/detail/am-ascend.jpg',
        heroCaption: 'The architect\'s mind is a way of seeing, cultivated by looking harder and by reading the makers in their own words.',
        levels: [
          { stage: 'Beginner — learn to look with judgement', items: [
            'Carry Vitruvius\'s three tests and apply them to one building a day: does it stand honestly (firmitas), serve its use well (utilitas), and give delight (venustas)?',
            'Practise naming what you feel. When a building pleases or unsettles you, ask why in concrete terms — proportion, symmetry, honesty of material — rather than "I just like it".',
            'Read one short primary voice: Vitruvius Book I on the making of an architect, free online. Notice that he begins with the person, not the plan.'
          ] },
          { stage: 'Intermediate — grasp the beliefs behind the building', items: [
            'Learn the harmonic idea: that the tradition believed the same simple ratios that make musical concord also make beautiful proportion, so that to build well was to echo a cosmic order. Hold it as a belief of theirs, not a proven fact.',
            'Read a maker on character and conscience: Ruskin\'s Seven Lamps (start with Truth and Memory), and Pugin\'s two true principles. Ask what each demands of the builder, not just the building.',
            'Test the "long view": find an old building near you and ask what its makers hoped their descendants would feel — then ask the same of a new one.'
          ] },
          { stage: 'Advanced — hold the argument, both sides', items: [
            'Read the modern critics who revived the moral case for beauty — Roger Scruton (Why Beauty Matters) and Christopher Alexander (The Timeless Way of Building) — and state their argument fairly.',
            'Then read it honestly against the other side: modernism arose from real convictions (honesty of structure, function, social housing, ornament as dishonest). Hold the debate as a genuine disagreement, not a settled verdict.',
            'Sit with the hinge idea — "we shape our buildings and afterwards our buildings shape us" (Churchill, 1943) — and watch, over weeks, how the rooms and streets you inhabit actually affect your mood and attention.'
          ] }
        ]
      },
      'practice': {
        title: 'To inhabit the architect\'s mind',
        intro: 'The disposition is built by practice, not just reading. A few concrete things to do and contemplate, to try on the tradition\'s way of seeing and judging.',
        heroImage: 'assets/detail/am-library.jpg',
        heroCaption: 'A great room asks something of you as you enter — the old conviction that a building can raise the mind to meet it.',
        items: [
          { name: 'Run the three tests, out loud', body: 'On any building that stops you, say aloud whether it passes firmness, commodity and delight — and why. Naming forces judgement, and judgement is the beginning of the architect\'s eye. Vitruvius set these three as the whole duty of a building; carry them like a craftsman\'s rule.' },
          { name: 'Ask what the maker believed', body: 'Stand before an old church, bank or town hall and ask: what did the people who raised this want you to feel — permanence, civic pride, devotion, welcome? A style is an argument, and the argument is usually about trust. Reading the belief behind the stone is the tradition\'s deepest habit.' },
          { name: 'Hunt for honesty and its opposite', body: 'Look for where a building tells the truth about itself — real stone, structure shown, ornament that grows from construction — and where it fakes it, in Ruskin\'s and Pugin\'s sense: plastic dressed as marble, a fake gable, machine-carving pretending to be hand-work. The test sharpens the conscience as well as the eye.' },
          { name: 'Take the long view', body: 'Pick one building and ask Ruskin\'s question of it: was this made for present use alone, or as "such work as our descendants will thank us for"? Then ask it of something being built near you now. The question quietly changes how you weigh everything.' },
          { name: 'Notice how a room changes you', body: 'Spend ten minutes in a well-proportioned old room and ten in a mean, low, harshly-lit modern one, and watch your own mood, breathing and attention. This is Churchill\'s idea tested on yourself — that buildings, having been shaped by us, then shape us in return.' },
          { name: 'Draw before you judge', body: 'Sketch a façade, however roughly, before deciding whether it is good. Drawing forces you to see the proportions and the parts as the maker did — where the weight falls, how the whole answers to its parts. The hand teaches the eye what mere looking misses.' }
        ]
      },
      'reading': {
        title: 'Where to read',
        intro: 'The makers wrote down what they believed, and the tradition is best met in their own voice. Primary sources first — several free and public-domain — then the modern writers who revived the moral case for beauty. Honest notes on difficulty and on where a text is one argued position rather than settled fact.',
        heroImage: 'assets/detail/roman-vitruvius.jpg',
        heroCaption: 'The makers wrote down what they believed; the tradition is best met in their own voice.',
        books: [
          { title: 'The Ten Books on Architecture (De Architectura), Book I', author: 'Vitruvius, c. 30–20 BC (Morgan translation, Harvard 1914)', note: 'PRIMARY. The foundation of the whole idea: Book I, chapter 1 is on the education and character of the architect. A technical treatise elsewhere — but Book I reads well and is the source of "firmness, commodity, delight". Free at Project Gutenberg.' },
          { title: 'On the Art of Building in Ten Books (De re aedificatoria)', author: 'Leon Battista Alberti, c. 1450 (Rykwert/Leach/Tavernor, MIT 1988)', note: 'PRIMARY. The architect as a wise servant of human needs, and beauty as concinnitas — "nothing may be added, taken away, or altered, but for the worse". The Latin original is public-domain; this modern English translation is in copyright.' },
          ...
          { title: 'The Stones of Venice — "The Nature of Gothic" (vol. II, ch. VI)', author: 'John Ruskin, 1853', note: 'PRIMARY. One chapter on the joy and freedom of the workman — that a building carries the soul of the hands that made it. Often printed alone; the single most humane thing Ruskin wrote. Free online.' },
          { title: 'The True Principles of Pointed or Christian Architecture', author: 'A. W. N. Pugin, 1841', note: 'PRIMARY. Architecture as the honest expression of a society\'s faith, and the two "true principles" of truthful building. Fierce and partisan — Pugin believed Gothic was the only Christian architecture — but the moral test of building is his. Free at the Internet Archive.' },
          { title: 'Kindergarten Chats and Other Writings', author: 'Louis Sullivan, essays 1896–1918', note: 'PRIMARY. The mystic behind the slogan. His 1896 essay coined "form ever follows function" — not as cold utility but as a spiritual law that all life expresses its inner nature in outward form. Older editions are public-domain.' },
          { title: 'Why Beauty Matters / The Aesthetics of Architecture', author: 'Roger Scruton, 2009 film / 1979 book', note: 'ON-RAMP (argued position). The modern philosophical case that beauty is a real, needed value and that much modern building has abandoned it. Eloquent and influential — but a contested stance, not settled fact. The 2009 BBC film is the easiest way in.' },
          { title: 'The Timeless Way of Building / A Pattern Language', author: 'Christopher Alexander (with others), 1977–79', note: 'ON-RAMP (argued position). The idea that living buildings and towns share a "quality without a name", and that traditional building processes produce it. Warm and readable; his stronger claim that some structures are objectively more "alive" is his theory, not proven.' },
          { title: 'The Architecture of Happiness', author: 'Alain de Botton, 2006', note: 'ON-RAMP (accessible, not academic). A popular, graceful argument that buildings speak to us and that we love the ones embodying the qualities we want more of in ourselves. The gentlest entry to the whole theme. In copyright.' }
        ]
      },
      'masters': {
        title: 'The makers, and what they believed',
        intro: 'Not a ranking, but a gallery of the architect\'s mind across the tradition — with, for each, a sentence on the inner conviction about why they built. Where a famous line or attribution is disputed, it is flagged honestly.',
        figures: [
          { name: 'Vitruvius (1st c. BC)', what: 'Roman architect and engineer whose De Architectura is the only architectural treatise to survive from antiquity. He believed the architect must be a learned and honest generalist, and that every building owes three things at once — firmitas, utilitas, venustas: to stand, to serve, to delight.',
            works: ['De Architectura (The Ten Books on Architecture)'], link: 'https://en.wikipedia.org/wiki/Vitruvius' },
          { name: 'Leon Battista Alberti (1404–1472)', portrait: 'assets/detail/portrait-alberti.jpg', what: 'Humanist, priest and architect who reframed the architect as a man of learning serving "the noble needs of man". He believed beauty was an objective harmony — concinnitas — from which nothing could be added or taken away but for the worse.',
            works: ['De re aedificatoria (On the Art of Building)', 'The façade of Santa Maria Novella, Florence', 'The Tempio Malatestiano, Rimini'], link: 'https://en.wikipedia.org/wiki/Leon_Battista_Alberti' },
          { name: 'Andrea Palladio (1508–1580)', portrait: 'assets/detail/portrait-palladio.jpg', what: 'The most imitated architect in history, who studied the Roman ruins by direct measurement. He believed beauty arose from the correspondence of the whole to the parts and the parts to the whole, and gave temple dignity to the ordinary business of living well.',
            works: ['I Quattro Libri dell\'Architettura (The Four Books)', 'Villa Rotonda (Villa Capra), Vicenza', 'San Giorgio Maggiore, Venice'], link: 'https://en.wikipedia.org/wiki/Andrea_Palladio' },
          { name: 'Sir Christopher Wren (1632–1723)', portrait: 'assets/detail/portrait-wren.jpg', what: 'Scientist, astronomer and architect who rebuilt London\'s churches after the Great Fire. He held that "architecture aims at eternity" and built "not for his own profit but for the public good" — the words of his epitaph in St Paul\'s: "Lector, si monumentum requiris, circumspice" ("Reader, if you seek his monument, look around you"), composed by his son.',
            works: ['St Paul\'s Cathedral, London', 'Fifty-one City churches', 'The Sheldonian Theatre, Oxford'], link: 'https://en.wikipedia.org/wiki/Christopher_Wren' },
          { name: 'Sir John Soane (1753–1837)', portrait: 'assets/detail/portrait-soane.jpg', what: 'The most original English architect of his age, who spoke of "the poetry of architecture" and treated light itself as a material — top-lit domes and hidden glass making rooms that shift with the day. He believed architecture a fine art carrying meaning and mood, not mere construction.',
            works: ['Sir John Soane\'s Museum, London', 'The Bank of England (largely lost)', 'Dulwich Picture Gallery'], link: 'https://en.wikipedia.org/wiki/John_Soane' },
          { name: 'A. W. N. Pugin (1812–1852)', portrait: 'assets/detail/portrait-pugin.jpg', what: 'The passionate apostle of the Gothic Revival, who believed architecture was the honest expression of a society\'s faith and that the decline of good building mirrored a decline in belief. Building, for him, was a moral test: truthful construction was a Christian duty.',
            works: ['The True Principles of Pointed Architecture', 'Contrasts (1836)', 'The interiors and detail of the Palace of Westminster'], link: 'https://en.wikipedia.org/wiki/Augustus_Pugin' },
          { name: 'John Ruskin (1819–1900)', portrait: 'assets/detail/portrait-ruskin.jpg', what: 'Critic, not builder, whose Seven Lamps made architecture a matter of conscience — sacrifice, truth, memory, obedience. He believed a building carries the soul of the hands that raised it, and that to demand machine-perfection is to unmake the workman.',
          ...
          { name: 'Louis Sullivan (1856–1924)', portrait: 'assets/detail/portrait-sullivan.jpg', what: 'The "father of the skyscraper", whose 1896 essay coined "form ever follows function". Beneath the slogan lay a mystic\'s creed: that every living thing expresses its inner nature in outward form, and that a building should do the same — a spiritual law, not cold utility.',
            works: ['The Wainwright Building, St Louis', 'The Guaranty Building, Buffalo', 'Kindergarten Chats (essays)'], link: 'https://en.wikipedia.org/wiki/Louis_Sullivan' },
          { name: 'Frank Lloyd Wright (1867–1959)', portrait: 'assets/detail/portrait-wright.jpg', what: 'Sullivan\'s pupil and the great prophet of "organic architecture" — building in harmony with humanity and its site, so that building, furnishing and landscape form one whole. He revised his master\'s rule to "form and function are one", and held that architecture should serve and elevate the life lived within it.',
            works: ['Fallingwater, Pennsylvania', 'The Guggenheim Museum, New York', 'An Organic Architecture (lectures)'], link: 'https://en.wikipedia.org/wiki/Frank_Lloyd_Wright' },
          { name: 'Sir Roger Scruton (1944–2020)', portrait: 'assets/detail/portrait-scruton.jpg', what: 'Philosopher who revived the case that beauty is a real and needed value, not mere taste. He argued that human-scaled, harmonious traditional building nourishes the spirit where much modernism, chasing utility and shock, impoverishes it — an eloquent, influential, and contested position, not a settled fact.',
            works: ['The Aesthetics of Architecture (1979)', 'Why Beauty Matters (BBC, 2009)', 'Chaired the Building Better, Building Beautiful Commission'], link: 'https://en.wikipedia.org/wiki/Roger_Scruton' }
        ]
      }
    }
  }
