  ...
  },
  {
    ...
    sections: {
      ...
      'the-path': {
        ...
        heroImage: 'assets/detail/gt-strawberry.jpg',
        heroCaption: 'Horace Walpole\'s Strawberry Hill — the light-hearted early "Gothick" fashion, before the revival turned serious and moral.',
        levels: [
      ...
      'practice': {
        ...
        heroImage: 'assets/detail/gt-vault.jpg',
        heroCaption: 'Look up for the ribs: a Gothic rib vault gathers the roof onto slender piers, like the spokes of an umbrella.',
        items: [
      ...
      'reading': {
        ...
        heroImage: 'assets/detail/gt-contrasts.jpg',
        heroCaption: 'Pugin\'s Contrasts — the movement\'s fiercest polemic, and still the vivid way in.',
        books: [
      ...
      'masters': {
        ...
        figures: [
          { name: 'A. W. N. Pugin (1812–1852)', portrait: 'assets/detail/portrait-pugin.jpg', what: 'The revival\'s prophet: a Catholic convert who wrote its theory (Contrasts, The True Principles), designed the Gothic detail of the Palace of Westminster, and built St Giles, Cheadle — packing several careers into twenty years before breaking down and dying at forty.',
          ...
          { name: 'Sir Charles Barry (1795–1860)', portrait: 'assets/detail/portrait-barry.jpg', what: 'The classically-trained architect who won the competition for the Palace of Westminster and set its plan and massing, with Pugin supplying the Gothic detail. Pugin\'s own verdict on Barry\'s classicism: "All Grecian, Sir; Tudor details on a classic body." The exact split of credit between them is still debated.',
          ...
          { name: 'Eugène Viollet-le-Duc (1814–1879)', portrait: 'assets/detail/portrait-violletleduc.jpg', what: 'The French rationalist and restorer — of Notre-Dame de Paris and the walls of Carcassonne — who read Gothic as pure structural logic and pointed it toward the modern age.',
            works: ['Restoration of Notre-Dame de Paris', 'Restoration of the walls of Carcassonne', '<i>Dictionnaire raisonné de l\'architecture française</i>'], link: 'https://en.wikipedia.org/wiki/Eug%C3%A8ne_Viollet-le-Duc' }
        ]
      }
    }
  }
